...
// TestGolden regenerates Go and C# output from the golden .consts.sdl input
// and writes the results alongside it. A developer reviews any diff against
// what's committed to verify correctness.
//
